...
- June 28, 2025: **Complete Cryptocurrency Deposit System** - Implemented professional crypto-only deposit workflow with USDT TRC-20, Bitcoin, and Ethereum support including admin-set wallet addresses, QR code generation, proof upload, and manual approval process
