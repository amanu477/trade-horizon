...
## Changelog
- July 7, 2025: **Fixed Trade Execution Issue** - Simplified validation logic to allow trades with any duration as long as user has sufficient balance for the trade amount. Removed complex capital range requirements that were preventing legitimate trades from executing
